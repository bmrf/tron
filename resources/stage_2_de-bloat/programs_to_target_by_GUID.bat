...
:: HP C4400_Help
start /wait msiexex /x {4F923F90-46D1-4492-9CC6-13FBBA00E7EC}
...
:: HP Help GUIDs (various versions for various products; most of these should be caught in the wildcard scan)
