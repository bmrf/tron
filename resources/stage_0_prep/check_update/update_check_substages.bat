...
if /i %LOCAL_STAGE_0_SCRIPT_VERSION% LSS %REPO_STAGE_0_SCRIPT_VERSION% (
	...
	call functions\log.bat " ! Splicing in Stage 0 v%REPO_STAGE_0_SCRIPT_VERSION% code. Old code renamed with .backup extension."
	move "stage_0_optimize\stage_0_optimize.bat" "stage_0_optimize\stage_0_optimize.bat.backup" >NUL
	move -y "%TEMP%\stage_0_optimize.bat" "stage_0_optimize\stage_0_optimize.bat" >NUL
...
if /i %LOCAL_STAGE_1_SCRIPT_VERSION% LSS %REPO_STAGE_1_SCRIPT_VERSION% (
	call functions\log.bat " ! Github Stage 1 code is v%REPO_STAGE_1_SCRIPT_VERSION% which is newer than local v%LOCAL_STAGE_1_SCRIPT_VERSION% code."
	call functions\log.bat " ! Splicing in Stage 1 v%REPO_STAGE_1_SCRIPT_VERSION% code. Old code renamed with .backup extension."
	move "stage_1_optimize\stage_1_optimize.bat" "stage_1_optimize\stage_1_optimize.bat.backup" >NUL
	move -y "%TEMP%\stage_1_optimize.bat" "stage_1_optimize\stage_1_optimize.bat" >NUL
	call functions\log.bat "   Done."
)
...
if /i %LOCAL_STAGE_2_SCRIPT_VERSION% LSS %REPO_STAGE_2_SCRIPT_VERSION% (
	call functions\log.bat " ! Github Stage 2 code is v%REPO_STAGE_2_SCRIPT_VERSION% which is newer than local v%LOCAL_STAGE_2_SCRIPT_VERSION% code."
	call functions\log.bat " ! Splicing in Stage 2 v%REPO_STAGE_2_SCRIPT_VERSION% code. Old code renamed with .backup extension."
	move "stage_2_optimize\stage_2_optimize.bat" "stage_2_optimize\stage_2_optimize.bat.backup" >NUL
	move -y "%TEMP%\stage_2_optimize.bat" "stage_2_optimize\stage_2_optimize.bat" >NUL
	call functions\log.bat "   Done."
)
...
if /i %LOCAL_STAGE_3_SCRIPT_VERSION% LSS %REPO_STAGE_3_SCRIPT_VERSION% (
	call functions\log.bat " ! Github Stage 3 code is v%REPO_STAGE_3_SCRIPT_VERSION% which is newer than local v%LOCAL_STAGE_3_SCRIPT_VERSION% code."
	call functions\log.bat " ! Splicing in Stage 3 v%REPO_STAGE_3_SCRIPT_VERSION% code. Old code renamed with .backup extension."
	move "stage_3_optimize\stage_3_optimize.bat" "stage_3_optimize\stage_3_optimize.bat.backup" >NUL
	move -y "%TEMP%\stage_3_optimize.bat" "stage_3_optimize\stage_3_optimize.bat" >NUL
	call functions\log.bat "   Done."
)
...
if /i %LOCAL_STAGE_4_SCRIPT_VERSION% LSS %REPO_STAGE_4_SCRIPT_VERSION% (
	call functions\log.bat " ! Github Stage 4 code is v%REPO_STAGE_4_SCRIPT_VERSION% which is newer than local v%LOCAL_STAGE_4_SCRIPT_VERSION% code."
	call functions\log.bat " ! Splicing in Stage 4 v%REPO_STAGE_4_SCRIPT_VERSION% code. Old code renamed with .backup extension."
	move "stage_4_optimize\stage_4_optimize.bat" "stage_4_optimize\stage_4_optimize.bat.backup" >NUL
	move -y "%TEMP%\stage_4_optimize.bat" "stage_4_optimize\stage_4_optimize.bat" >NUL
	call functions\log.bat "   Done."
)
...
if /i %LOCAL_STAGE_5_SCRIPT_VERSION% LSS %REPO_STAGE_5_SCRIPT_VERSION% (
	call functions\log.bat " ! Github Stage 5 code is v%REPO_STAGE_5_SCRIPT_VERSION% which is newer than local v%LOCAL_STAGE_5_SCRIPT_VERSION% code."
	call functions\log.bat " ! Splicing in Stage 5 v%REPO_STAGE_5_SCRIPT_VERSION% code. Old code renamed with .backup extension."
	move "stage_5_optimize\stage_5_optimize.bat" "stage_5_optimize\stage_5_optimize.bat.backup" >NUL
	move -y "%TEMP%\stage_5_optimize.bat" "stage_5_optimize\stage_5_optimize.bat" >NUL
	call functions\log.bat "   Done."
)
...
if /i %LOCAL_STAGE_6_SCRIPT_VERSION% LSS %REPO_STAGE_6_SCRIPT_VERSION% (
	call functions\log.bat " ! Github Stage 6 code is v%REPO_STAGE_6_SCRIPT_VERSION% which is newer than local v%LOCAL_STAGE_6_SCRIPT_VERSION% code."
	call functions\log.bat " ! Splicing in Stage 6 v%REPO_STAGE_6_SCRIPT_VERSION% code. Old code renamed with .backup extension."
