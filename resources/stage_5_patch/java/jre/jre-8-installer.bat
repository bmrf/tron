...
:: History:       1.6.1-TRON / Branch into Tron-specific version
::                           * Switch to version-agnostic installation, will now detect system architecture and run appropriate installer
::                1.6.0      * Reworked CUR_DATE variable to handle all Windows date formats regardless of locale
::                1.0.0      + Initial write
...
set LOGPATH=%SystemDrive%\Logs\tron\raw
set LOGFILE=tron_jre8_update.log

:: Package to install. Do not use trailing slashes (\)
set BINARY_VERSION=8u60
